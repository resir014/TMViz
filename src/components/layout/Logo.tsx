...
const Logo: React.FC<LogoProps> = ({ mode, width, height, ...rest }) => {
  return (
    <svg width={width} height={height} viewBox="0 0 337 124" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
        ...
        fill={mode === 'light' ? theme.colors.black : theme.colors.white}
      />
      <rect width="169" height="124" transform="translate(168)" fill={mode === 'light' ? theme.colors.black : theme.colors.white} />
      <path
        ...
        fill={mode === 'light' ? theme.colors.white : theme.colors.black}
      />
    </svg>
  )
}
