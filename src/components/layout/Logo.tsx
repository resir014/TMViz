  ...
  return (
    <svg width={width} height={height} viewBox="0 0 337 124" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
        ...
        fill={mode === 'light' ? customColors.black : customColors.white}
      />
      <rect width="169" height="124" transform="translate(168)" fill={mode === 'light' ? customColors.black : customColors.white} />
      <path
        ...
        fill={mode === 'light' ? customColors.white : customColors.black}
      />
    </svg>
  )
}
